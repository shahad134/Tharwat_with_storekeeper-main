(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-storekeeper-orders-orders-module~pages-storekeeper-storekeeper-module"], {
    ...
    /***/
    function e24e(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_orders_details_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./orders-details.component.html */
      "eT+c");
      /* harmony import */


      var _orders_details_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_models_storeKeeper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/models/storeKeeper */
      "fb76");

      var OrdersDetailsComponent = /*#__PURE__*/function () {
        function OrdersDetailsComponent(modalController, actionSheetController, httpService, alertService, navCtrl, param) {
        ...
        _createClass(OrdersDetailsComponent, [{
          ...
          value: function submit() {
            ...
            this.httpService.post('auth/store_storekeeper_d', data).subscribe(function (data) {
              _this.alertService.presentToast("تم تحديث البيانات بنجاح");
            }, function (error) {
          ...
          value: function ionViewWillEnter() {
            ...
            this.httpService.getWithParam('auth/receive_orders', this.order_number, name).subscribe(function (receivedOrders) {
              _this2.receivedOrders = receivedOrders;
              console.log('order_number inside: ', receivedOrders);
            }, function (error) {
              console.log(error);
            }, function () {
              _this2.form = [{
                val: _this2.receivedOrders[0].furniture,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].clothes,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].dishes,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].electrical_tools,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].baby_things,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].luxuries,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].accessories_and_mobiles,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].medical_devices,
                isChecked: false
              }, {
                val: _this2.receivedOrders[0].miscellaneous,
                isChecked: false
              }];

              for (var i in _this2.form) {
                if (_this2.form[i].val !== null) {
                  _this2.arr.push({
                    'val': JSON.stringify(_this2.form[i].val),
                    'isChecked': false
                  });
                }
              }
              ...
              console.log('Arr Data: ', _this2.arr);
            });
          }
        }]);
    ...
    /***/
    function fb76(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "storeKeeper", function () {
        return storeKeeper;
      });

      var storeKeeper = function storeKeeper() {
    ...
    /***/
    function gJFK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~pages-storekeeper-orders-orders-module~pages-storekeeper-storekeeper-module-es5.js.map