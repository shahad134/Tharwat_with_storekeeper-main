(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-auth-login-login-module~pages-auth-register-register-module"], {
    ...
    /***/
    function d1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function NKrf(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_pages_custmer_rest_rest_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/pages/custmer/rest/rest.page */
      "afyf");
      ...
      var LoginPage = /*#__PURE__*/function () {
        ...
        _createClass(LoginPage, [{
          ...
          value: function rememberMe() {
            this.checked = !this.checked; // console.log("checked: " + this.checked);//it is working !!!
          } // Dismiss Login Modal
          ...
          value: function login(form) {
            ...
            this.authService.login(form.value.email, form.value.password).subscribe(function (data) {
              ...
              _this.alertService.presentToast("تم تسجيل الدخول");

              console.log(data);
            }, function (error) {
              _this.alertService.presentToast("خطأ في اسم المستخدم أو كلمة المرور");

              console.log(error);
            }, function () {
              _this.dismissLogin();

              _this.rot = localStorage.getItem('is_admin');

              _this.navCtrl.navigateRoot(_this.rot);
            });
          }
        }, {
          key: "showForgetPassword",
          value: function showForgetPassword() {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                      forgetModal = _context2.sent;
                      _context2.next = 5;
                      return forgetModal.present();
    ...
    /***/
    function SixS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var RegisterPage = /*#__PURE__*/function () {
        ...
        _createClass(RegisterPage, [{
          ...
          value: function register(form) {
            ...
            this.authService.register(form.value.name, form.value.email, form.value.password).subscribe(function (data) {
              _this2.authService.login(form.value.email, form.value.password).subscribe(function (data) {}, function (error) {
                console.log(error);
              }, function () {
                _this2.dismissRegister(); // this.navCtrl.navigateRoot('/donations');
    ...
    /***/
    function Z2Lw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function afyf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_rest_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./rest.page.html */
      "U/zi");
      /* harmony import */


      var _rest_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./rest.page.scss */
      "Z2Lw");
      /* harmony import */
      ...
      var RestPage = /*#__PURE__*/function () {
        function RestPage(modalController, navCtrl, route, alertService, authService) {
        ...
        _createClass(RestPage, [{
          ...
          value: function reset(form) {
            ...
            this.authService.reset(form.value.email).subscribe(function (data) {
              _this3.alertService.presentToast("Send password link");
            }, function (error) {
              console.log(error);

              _this3.alertService.presentToast("error");
            }, function () {
              _this3.dismissReset();
      ...
      RestPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-rest',
    ...
    /***/
    function ak2j(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~pages-auth-login-login-module~pages-auth-register-register-module-es5.js.map