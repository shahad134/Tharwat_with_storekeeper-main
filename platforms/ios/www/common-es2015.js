...
/* harmony import */ var _raw_loader_orders_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./orders.page.html */ "fpwJ");
/* harmony import */ var _orders_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./orders.page.scss */ "sfwI");
...
/* harmony import */ var _orders_details_orders_details_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../orders-details/orders-details.component */ "e24e");
...
let OrdersPage = class OrdersPage {
    ...
    ionViewWillEnter() {
        ...
        let name = 'user_id';
        this.httpService.getWithParam('auth/get_driver_order', this.id, name).subscribe(orders => {
            this.orders = orders;
        }, error => {
            console.log(error);
        });
...
/* harmony import */ var _orders_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./orders-routing.module */ "zaeA");
/* harmony import */ var _orders_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./orders.page */ "VzuS");
...
/* harmony import */ var _orders_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./orders.page */ "VzuS");
