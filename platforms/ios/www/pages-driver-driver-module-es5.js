(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-driver-driver-module"], {
    ...
    /***/
    function tzE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function A0v(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function CGH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FKGi(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function JQWR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Q9Hu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _order_details_accept_order_details_accept_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./order-details -accept/order-details -accept.component */
      "tpZm");
      /* harmony import */


      var _new_new_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./new/new.component */
      "nKbU");
      /* harmony import */
      ...
      var _finish_finish_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./finish/finish.component */
      "XIzR");
      ...
      DriverPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _driver_routing_module__WEBPACK_IMPORTED_MODULE_5__["DriverPageRoutingModule"]],
    ...
    /***/
    function RBha(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function WkuH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function XIzR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_finish_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./finish.component.html */
      "CG+H");
      /* harmony import */


      var _finish_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var finishComponent = /*#__PURE__*/function () {
        function finishComponent(modalController, navCtrl, httpService, authService, env) {
        ...
        _createClass(finishComponent, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.httpService.makeGet('auth/api_receive_orders_finish').subscribe( // user => {
            //   this.user = user;
            // },
            function (order_info) {
              _this2.order_info = order_info;
              console.log(order_info);
            });
            this.httpService.makeGet('auth/index').subscribe(function (connect_info) {
              _this2.connect_info = connect_info;
      ...
      finishComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Z9XF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ZCUc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var OrderDetailsComponent = /*#__PURE__*/function () {
        ...
        _createClass(OrderDetailsComponent, [{
          ...
          value: function submit() {
            ...
            this.httpService.post('auth/update_status', data).subscribe(function (data) {// this.alertService.presentToast("تم تحديث البيانات بنجاح");
            }, function (error) {
          ...
          value: function ionViewWillEnter() {
            ...
            this.httpService.getWithParam('auth/receive_donation', this.order_number, name).subscribe(function (donations_info) {
              _this4.donations_info = donations_info;
    ...
    /***/
    function adCc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function e0ne(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fuVX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function j0SS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _order_details_accept_order_details_accept_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../order-details -accept/order-details -accept.component */
      "tpZm");
      /* harmony import */
      ...
      var src_app_services_param_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/services/param.service */
      "5DBH");
      /* harmony import */
      ...
      var HistoryComponent = /*#__PURE__*/function () {
        ...
        _createClass(HistoryComponent, [{
                  ...
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 3:
                      ...
                      modal.onDidDismiss().then(function () {
                        setTimeout(function () {
                          _this5.httpService.makeGet('auth/api_receive_orders_accept').subscribe(function (order_info) {
                            _this5.order_info = order_info;
                            console.log(_this5.order_info);
                          }, function (error) {
                            console.log(error);

                            _this5.alertService.presentToast(error['message']);
                          });
                        }, 10);
          ...
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {// this.param.order_number = this.order_number;
          ...
          value: function ionViewDidEnter() {
            this.refreshValues(); // //Start periodic Refresh
            // this.interval = setInterval(() => {
            //   this.refreshValues()
            // }, 6000);
          }
          ...
          value: function ionViewDidLeave() {
            this.refreshValues(); // //Stop refresh
          ...
          value: function refreshValues() {
            ...
            // for(let i = 0; i <3; i++){
            // this.interval = setInterval(() => {  
            this.httpService.makeGet('auth/api_receive_orders_accept').subscribe(function (order_info) {
              _this6.order_info = order_info;
              console.log(_this6.order_info);
            }, function (error) {
              console.log(error);

              _this6.alertService.presentToast(error['message']);
            });
            this.httpService.makeGet('auth/index').subscribe(function (connect_info) {
              _this6.connect_info = connect_info;
            });
          }
        }]);
        ...
        _createClass(HttpServiceService, [{
          ...
          value: function post(endpoint, data) {
            ...
            return this.http.post(this.env.API_URL + endpoint, data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (data) {
              return console.log(_this9.env.API_URL + endpoint);
            }));
          }
        }, {
          key: "get",
          value: function get(endpoint) {
            ...
            return this.http.get(this.env.API_URL + endpoint).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["tap"])(function (data) {
              return console.log(_this10.env.API_URL + endpoint);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError('getData', [])));
          }
        }, {
          key: "getWithParam",
          value: function getWithParam(endpoint, param, name) {
            ...
            return this.http.get(this.env.API_URL + endpoint, {
              ...
              return console.log(_this11.env.API_URL + endpoint);
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(this.handleError('getData', [])));
          }
        }, {
          key: "handleError",
    ...
    /***/
    function nKbU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var NewComponent = /*#__PURE__*/function () {
        function NewComponent(modalController, navCtrl, httpService, authService, env, alertService, param) {
        ...
        _createClass(NewComponent, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.param.order_number = this.order_number;
            this.httpService.makeGet('auth/api_receive_orders_wait').subscribe(function (order_info) {
              _this13.order_info = order_info;
              console.log('order_info: ', _this13.order_info);
            }, function (error) {
              console.log(error);

              _this13.alertService.presentToast(error['message']);
            });
            this.httpService.makeGet('auth/index').subscribe(function (connect_info) {
              _this13.connect_info = connect_info;
              console.log(connect_info);
            });
          }
        }]);
    ...
    /***/
    function nUzI(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "receivedOrders", function () {
        return receivedOrders;
      });

      var receivedOrders = function receivedOrders() {
        _classCallCheck(this, receivedOrders);
      };
      /***/
    ...
    /***/
    function rCWc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function tpZm(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "OrderDetailsAcceptComponent", function () {
        return OrderDetailsAcceptComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_order_details_accept_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./order-details -accept.component.html */
      "DlNB");
      /* harmony import */


      var _order_details_accept_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./order-details -accept.component.scss */
      "JQWR");
      /* harmony import */
      ...
      var src_app_models_receivedOrders__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/models/receivedOrders */
      "nUzI");

      var OrderDetailsAcceptComponent = /*#__PURE__*/function () {
        function OrderDetailsAcceptComponent(modalController, actionSheetController, httpService, alertService, navCtrl, param) {
          _classCallCheck(this, OrderDetailsAcceptComponent);
        ...
        _createClass(OrderDetailsAcceptComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }, {
          key: "dismiss",
          ...
          value: function submit() {
            ...
            this.order_number = this.param.order_number;
            this.httpService.post('auth/update_status_finish', data).subscribe(function (data) {
              _this14.alertService.presentToast("تم تحديث البيانات بنجاح");
            }, function (error) {
              console.log(error.error);
            }, function () {
            ...
            this.httpService.post('auth/add_orders', data1).subscribe(function (data1) {
              _this14.alertService.presentToast("تم تحديث البيانات بنجاح");
            }, function (error) {
              console.log(error.error);
            }, function () {
          ...
          value: function ionViewWillEnter() {
            ...
            var name = 'order_number';
            this.httpService.getWithParam('auth/receive_donation', this.order_number, name).subscribe(function (donations_info) {
              _this15.donations_info = donations_info;
              console.log('donations_info inside', donations_info);
            }, function (error) {
              console.log(error);
            }, function () {
              _this15.form = [{
                val: _this15.donations_info[0].furniture,
                isChecked: false
              }, {
                val: _this15.donations_info[0].clothes,
                isChecked: false
              }, {
                val: _this15.donations_info[0].dishes,
                isChecked: false
              }, {
                val: _this15.donations_info[0].electrical_tools,
                isChecked: false
              }, {
                val: _this15.donations_info[0].baby_things,
                isChecked: false
              }, {
                val: _this15.donations_info[0].luxuries,
                isChecked: false
              }, {
                val: _this15.donations_info[0].accessories_and_mobiles,
                isChecked: false
              }, {
                val: _this15.donations_info[0].medical_devices,
                isChecked: false
              }, {
                val: _this15.donations_info[0].miscellaneous,
                isChecked: false
              }];

              for (var i in _this15.form) {
                if (_this15.form[i].val !== 'null') {
                  _this15.arr.push({
                    'val': JSON.stringify(_this15.form[i].val),
                    'isChecked': false
                  });
                }
              }
              ...
              console.log('Arr Data: ', _this15.arr);
            });
            this.order_number = this.param.order_number;
            this.httpService.getWithParam('auth/receive_infoconnect', this.order_number, name).subscribe(function (connect_info) {
              _this15.connect_info = connect_info;
            }, function (error) {
              console.log(error);
            });
          }
      ...
      OrderDetailsAcceptComponent.ctorParameters = function () {
        return [{
          type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"]
        }, {
          type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ActionSheetController"]
      ...
      OrderDetailsAcceptComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function vsBh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=pages-driver-driver-module-es5.js.map